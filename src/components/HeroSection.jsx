        ...
        <div className={'flex flex-col items-center mt-6 lg:mt-20'}>
            ...
            <div className={'flex mt-10 justify-center'}>
                <video autoPlay loop muted className={'rounded-lg w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4'}>
                    <source src={'https://github.com/chayan-1906/Virtual-R/assets/82430454/73e44f10-7045-4399-ac5d-2194e0602e7e'} type={'video/mp4'}/>
                    Your browser does not support videos
                </video>
                <video autoPlay loop muted className={'rounded-lg w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4'}>
                    <source src={'https://github.com/chayan-1906/Virtual-R/assets/82430454/f2200254-99e9-454d-bff9-57f60a6e2133'} type={'video/mp4'}/>
                    Your browser does not support videos
                </video>
            </div>
        </div>
