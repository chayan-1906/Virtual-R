                    ...
                    pricingOptions.map((pricingOption, index) => (
                        <div key={index} className={'w-full sm:w-1/2 lg:w-1/3 p-2'}>
                            <div className={'p-10 border border-neutral-700 rounded-xl'}>
                                <p className={'text-4xl mb-8'}>{pricingOption.title}
                                    {
                                        pricingOption.title === 'Pro' && (
                                            <span className={'bg-gradient-to-r from-orange-500 to-red-400 text-transparent bg-clip-text text-2xl mb-4 ml-2'}>
                                                (Most Popular)
                                            </span>
                                        )
                                    }
                                ...
                                <p className={'mb-8'}>
                                    ...
                                    <span className={'text-2xl text-neutral-400 tracking-tight'}>/Month</span>
                                </p>
                                <ul>
                                    {
